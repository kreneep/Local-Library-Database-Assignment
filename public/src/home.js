function getTotalBooksCount(books) {
  /*
    This function should returns a number that represents 
    the number of book objects inside of the array.
  */
...
function getBooksBorrowedCount(books) {
  ...
  // Filter the books that are currently checked out (not returned)
  ...
  /*
    - using reduced.(), all elements of the array it iterates on into a single value
